                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <div class="am-form-group">
                            <?php //if (checkPrivilege('user/add')): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (($stage['user']['user_id'] != $item['user_id'])
                                                && !$item['is_super']): ?>
                                                <?php if (checkPrivilege('admin.user/edit')): ?>
                                                    <a href="<?= url('admin.user/edit', ['user_id' => $item['user_id']]) ?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                <?php endif; ?>
                                                <?php if (checkPrivilege('admin.user/delete')): ?>
