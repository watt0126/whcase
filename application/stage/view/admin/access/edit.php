                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
							...
							<div class="am-form-group">
							    <label class="am-u-sm-3 am-u-lg-2 am-form-label">菜单图标</label>
							    <div class="am-u-sm-9 am-u-end">
							        <input type="text" class="tpl-form-input" name="access[menu_icon]"
							               value="<?= $model['menu_icon'] ?>">
							        <small>例如：icon-shouye</small>
							    </div>
							</div>
