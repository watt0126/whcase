                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">更新专题信息</div>
                            </div>
							...
							<div class="am-form-group">
							    ...
							    <div class="am-u-sm-9 am-u-end">
							        <input type="text" class="tpl-form-input" name="special[url]"
							               value="<?= $model['url']?>" placeholder="请填写专题链接" required>
                                    ...
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
												<div class="file-item">
												    <a href="<?= $model['image']['file_path']?>" title="点击查看大图" target="_blank">
												        <img src="<?= $model['image']['file_path']?>">
												    </a>
												    <input type="hidden" name="special['image_id']" value="<?= $model['image_id']?>">
