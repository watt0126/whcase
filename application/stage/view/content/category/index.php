                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <?php if (checkPrivilege('content.category/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= url('content.category/add') ?>">
                        ...
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black">
                            ...
                            <?php if (!empty($list)): foreach ($list as $first): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?= $first['name_h1'] ?></td>
                                    <td class="am-text-middle"><?= $first['sort'] ?></td>
                                    <td class="am-text-middle"><?= $first['create_time'] ?></td>
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('content.category/edit')): ?>
                                                <a href="<?= url('content.category/edit',
                                                    ['category_id' => $first['category_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('content.category/delete')): ?>
