							        ...
							        <div class="am-form-group am-fl">
							            ...
							            <select name="user_id"
							                ...
							                <option value="<?= $item['user_id'] ?>"
							                    <?= $user_id == $item['user_id'] ? 'selected' : '' ?>><?= $item['real_name'] ?>
							                </option>
											<?php endforeach; endif; ?>
							            </select>
							        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <a href="<?= $item['image'][0]['file_path'] ?>" title="点击查看大图" target="_blank">
                                            <img src="<?= $item['image'][0]['file_path'] ?>" height="72" alt="">
                                        </a>
                                    </td>
                                    <td class="am-text-middle"><?= $item['category']['name'] ?></td>
                                    <td class="am-text-middle"><?= $item['user']['real_name'] ?></td>
                                    <td class="am-text-middle"><?= $item['article_sort'] ?></td>
                                    <td class="am-text-middle">
                                           <span class="am-badge am-badge-<?= $item['article_command'] ? 'success' : 'warning' ?>">
                                               <?= $item['article_command'] ? '推荐' : '普通' ?>
                                           </span>
                                    </td>
