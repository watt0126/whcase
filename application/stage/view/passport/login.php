...
<div class="container">
    <div id="wrapper" class="login-body">
        <div class="login-content">
            <div class="brand">
                <img alt="logo" class="brand-img" src="__STATIC__/stage/img/login/logo.png">
                <h2 class="brand-text">案例信息系统</h2>
            </div>
