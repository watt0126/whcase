...
use app\stage\service\Auth;
use app\stage\service\Menus;
...
class Controller extends \think\Controller
{
	...
	private function layout()
	{
	    ...
	    if (!in_array($this->routeUri, $this->notLayoutAction)) {
	        ...
	        $this->assign([
	            ...
	            'stage_url' => url('/stage'),              // 后台模块url
	            'group' => $this->group,                       // 当前控制器分组
	            'menus' => $this->menus(),                     // 后台菜单
	            'stage' => $this->stage,                       // 商家登录信息
	            //'setting' => Setting::getAll() ?: null,        // 当前后台设置
	...
	private function checkLogin()
	{
	    ...
	    // 验证登录状态
	    if (empty($this->stage) || (int)$this->stage['is_login'] !== 1) {
